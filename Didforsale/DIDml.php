...
use Didforsale\Exceptions\DIDmlException;
...
class DIDml{
    ...
    /**
     * Constructs a DIDml response.
     *
     * @param \SimpleXmlElement|array $arg
     * @throws DIDmlException
    ...
    public function __construct($arg = null) {
        switch (true) {
            ...
            case is_array($arg):
                ...
                break;
            default:
                throw new DIDmlException('Invalid argument');
        }
    }
    
    /**
     * Converts method calls into DIDml verbs.
     *
     * A basic example:
     *
     * .. code-block:: php
     ...
     * .. code-block:: php
     *
     *     print $this->say('hello', array('voice' => 'man'));
     ...
     *     <Gather timeout="20"/>
     *
     * @param string $verb The DIDml verb.
     * @param mixed[] $args
     * @return self
     * :param string $verb: The DIDml verb.
     * :param array  $args:
